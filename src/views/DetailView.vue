...
//computer lebihlu dipanggil dari yang lain
import { useUserStore } from '@/stores/user'
import GaleryView from "@/components/detail/GaleryView.vue";
    ...
    <div class="container p-2 mx-auto my-10 max-w-7xl">
      <div class="flex flex-row flex-wrap py-4">
        <main role="main" class="w-full px-4 pt-1 sm:w-2/3 md:w-2/3">
          ...
          <GaleryView :defaultImage="item.thumbnails" :galleries="item.galleries"/>
            ...
            <div class="p-6 border rounded-2xl">
              ...
              <div>
                ...
                <ul class="mb-6 text-gray-500" v-if="item">
                  <li class="mb-2" v-for="feature in features" :key="feature.id">
                    {{ feature }}
                    <img
